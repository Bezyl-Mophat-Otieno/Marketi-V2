...
const  Contact = ()=> {
    ...
    const show = () => {
        toast.current?.show({ severity: 'info', summary: 'Success', detail: 'Message Sent Successfully , we will get back to you', life: 3000 });
    };
  ...
  return (
    ...
    <ScrollAnimationWrapper  className="text-gray-600 body-font relative  w-screen" >
      <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap" id="contact">
        ...
        <motion.div variants={scrollAnimation} className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
          <h2 className="text-gray-900 text-lg mb-1 font-medium title-font">
            Feedback
          </h2>
          <p className="leading-relaxed mb-5 text-gray-600">
          Feel free to drop by during these hours, or contact us through one of the channels mentioned bellow.          </p>
